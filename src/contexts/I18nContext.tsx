...
const dictionaries: Dictionary = {
    'en': {
        ...
        'guest.identifierPlaceholder': 'Email or Phone Number',
        ...
        'guests.tabs.control': 'Access Control',
        'guests.control.title': 'Guest Access Control',
        'guests.control.subtitle': 'Manage how visitors access your exhibition.',
        'guests.control.approval': 'Require Approval',
        'guests.control.approvalDesc': 'New guests must be approved by you',
        'guests.control.invitation': 'Use Invitation Code',
        'guests.control.invitationDesc': 'Only visitors with code can register',
        'guests.control.disableLogin': 'Temporarily Disable Login',
        'guests.control.disableLoginDesc': 'Existing guests cannot log in',
        'guests.control.disableReg': 'Disable New Registration',
        'guests.control.disableRegDesc': 'Prevent new visitor signups',
        'guests.control.invitationCode': 'Current Invitation Code',
        'guests.control.setCode': 'Set Code',
        'guests.control.updateSuccess': 'Settings updated successfully!',
    ...
    'zh-CN': {
        ...
        'guest.identifierPlaceholder': '邮箱或手机号',
        ...
        'guests.tabs.control': '访问控制',
        'guests.control.title': '访客访问控制',
        'guests.control.subtitle': '管理访客如何访问您的展厅。',
        'guests.control.approval': '需要审核',
        'guests.control.approvalDesc': '新访客注册后需经过您的审核',
        'guests.control.invitation': '使用邀请码',
        'guests.control.invitationDesc': '仅持有邀请码的访客可以注册',
        'guests.control.disableLogin': '暂时关闭登录',
        'guests.control.disableLoginDesc': '已注册访客将无法登录',
        'guests.control.disableReg': '禁止新用户注册',
        'guests.control.disableRegDesc': '暂时停止新访客注册功能',
        'guests.control.invitationCode': '当前有效邀请码',
        'guests.control.setCode': '更新',
        'guests.control.updateSuccess': '配置已成功同步！',
        ...
        'guest.registrationClosed': '当前已关闭访客注册',
        'guest.systemMaintenance': '访客系统维护中，请稍后再试。',
        ...
        'parent.guests': '访客管理',
        'parent.guestsDesc': '审核访客、管理充值码及 IP 限制。',
