...
--> statement-breakpoint
INSERT INTO `__new_Order`("id", "artworkId", "visitorId", "amountRMB", "amountCoins", "paymentType", "status", "contactName", "contactPhone", "contactEmail", "shippingAddress", "trackingNumber", "qrCodeUrl", "createdAt", "updatedAt") SELECT "id", "artworkId", "visitorId", "amountRMB", "amountCoins", "paymentType", "status", "contactName", "contactPhone", "contactEmail", "shippingAddress", "trackingNumber", "qrCodeUrl", "createdAt", "updatedAt" FROM `Order`;--> statement-breakpoint
...
ALTER TABLE `Visitor` ADD `password` text;