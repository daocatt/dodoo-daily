...
export default function ProfileWidget() {
    ...
    if (!stats) return (
        <div className="w-full h-full bg-white/40 backdrop-blur-md rounded-[2.5rem] animate-pulse border border-white/20" />
    )
    ...
    return (
        <motion.div
            ...
            className="w-full h-full bg-white/60 backdrop-blur-xl rounded-[2.5rem] p-6 lg:p-8 border border-white/40 shadow-xl shadow-slate-200/50 flex flex-col justify-between group overflow-hidden relative"
        >
            {/* Background Accent */}
            ...
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                    <div className="relative">
                        <div className="w-16 h-16 rounded-[1.5rem] border-4 border-white shadow-xl overflow-hidden bg-slate-100 transition-transform group-hover:scale-110">
                            {stats.avatarUrl ? (
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-0.5 bg-slate-900/5 rounded-full w-fit">
                            ...
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Master Explorer</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4 my-4">
                <div className="bg-slate-50/80 rounded-2xl p-3 border border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                        <span className="text-[8px] font-black text-slate-300 uppercase block tracking-tighter">Height</span>
                ...
                <div className="bg-slate-50/80 rounded-2xl p-3 border border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                        <span className="text-[8px] font-black text-slate-300 uppercase block tracking-tighter">Weight</span>
            ...
            <div className="space-y-2">
                <div className="flex justify-between items-end px-1">
                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Growth Level {level}</span>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
                <div className="bg-[#FFFBEB] p-4 rounded-[2rem] border border-amber-100 flex flex-col items-center justify-center group/stat transition-all hover:bg-amber-100/50">
                    ...
                    <span className="text-[9px] font-black text-amber-400/80 uppercase tracking-[0.2em]">Coins</span>
                </div>
                <div className="bg-[#EEF2FF] p-4 rounded-[2rem] border border-indigo-100 flex flex-col items-center justify-center group/stat transition-all hover:bg-indigo-100/50">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[9px] font-black text-indigo-400/80 uppercase tracking-[0.2em]">Stars</span>
                </div>
            </div>
        </motion.div>
    )
