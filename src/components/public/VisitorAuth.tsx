...
interface VisitorAuthProps {
    onSuccess: (visitorData: VisitorData) => void
...
export default function VisitorAuth({ onSuccess, disableRegistration, asTerminal = true }: VisitorAuthProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const endpoint = mode === 'LOGIN' ? '/api/visitor/login' : '/api/visitor/register'
